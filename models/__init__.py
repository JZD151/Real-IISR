...
def build_var(
    ...
    control_patch_nums = (1, 2, 3, 4, 5, 6, 8, 10, 13, 16),
    # VQVAE args
    V=4096, Cvae=32, ch=160, share_quant_resi=4,controlnet_depth=8,
    # VAR args
    ...
    var_wo_ddp = Real_IISR(
        ...
        norm_eps=1e-6, shared_aln=shared_aln, cond_drop_rate=0.0,
